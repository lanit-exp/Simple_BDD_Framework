#language:ru
@djangoHr
Функционал: Проверка корректности удаления сотрудника под ролью HR
  ...
  Сценарий: Нажать кнопку 'Проектные ставки', в текущем блоке нажать
  на ссылку текстом 'Добавить еще один Проектная ставка', проверить, что
  в текущем блоке поле 'Проект' не заполнено, затем нажать на ссылку текстом
  'Скрыть', проверить, что поле 'Проект' отсутствует

    Дано инициализация страницы "DjangoEmployeeChange"
    Если на странице имеется элемент "Проектные ставки"
    Тогда нажать на "Проектные ставки"
    Если на странице имеется элемент "Добавить еще один Проектная ставка"
    Тогда нажать на "Добавить еще один Проектная ставка"
    Если чекбокс "Проект Проектные ставки" отображается и не выбран
    Тогда нажать на "Скрыть Проектные ставки"
    Если на странице отсутствует элемент "Проект Проектные ставки"
