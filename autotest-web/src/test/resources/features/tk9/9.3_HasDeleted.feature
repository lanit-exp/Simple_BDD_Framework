...
Функционал: Проверка корректности удаления сотрудника под ролью HR
  ...
  Сценарий: Нажать кнопку 'Удалено', проверка присутствия инфоблока с текстом
  'Вы уверены?'

    Дано инициализация страницы "DjangoEmployeeChange"
    Если проскроллить страницу до элемента "Удалено"
    Тогда нажать на "Удалено"
    Тогда переход на страницу "DjangoDeleteEmployee"
    Если на странице присутствует текст "Вы уверены?"
    Тогда проскроллить страницу до элемента "Вы уверены?"