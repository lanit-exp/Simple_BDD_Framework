#language:ru
@djangoHr
Функционал: Проверка отсутствия активности элемента на странице "Сотрудники" под ролью Public
  ...
  Сценарий: Проверка отсутствия активности элемента Фамилия
    ...
    Если элемент "Фамилия Public" заблокирован