#language:ru
@DjangoAddEmployee
Функционал: Проверка заполнения поля "Дата рождения" через ввод с клавиатуры
  Предыстория:
  ...
  Сценарий: В поле 'Дата рождения' нажать на кнопку календаря, в текущем поле
  ввести любое значение в формате 'дд.мм.гггг'
    Дано инициализация страницы "DjangoEmployeeChange"
    Если очистить поле "День рождения"
    То поле "День рождения" содержит значение ""
    Тогда ввести в поле "День рождения" значение "18.11.2021"