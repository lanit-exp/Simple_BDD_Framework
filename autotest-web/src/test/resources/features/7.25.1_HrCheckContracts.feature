#language:ru
@djangoHr
Функционал: Проверка корректности работы блока Договоры под ролью HR
  ...
  Сценарий: Нажать кнопку 'Договоры', в текущем блоке нажать
  на ссылку текстом 'Добавить еще один Договор', проверить, что
  в текущем блоке поле 'Должность' не заполнено, затем нажать на ссылку
  текстом 'Скрыть Договоры', проверить, что поле 'Должность' отсутствует

    Дано инициализация страницы "DjangoEmployeeChange"
    Если на странице имеется элемент "Договоры"
    Тогда нажать на "Договоры"
    Если на странице имеется элемент "Добавить еще один Договор"
    Тогда нажать на "Добавить еще один Договор"
    Если чекбокс "Договоры Должность" отображается и не выбран
    Тогда нажать на "Скрыть"
    Если на странице отсутствует элемент "Договоры Должность"