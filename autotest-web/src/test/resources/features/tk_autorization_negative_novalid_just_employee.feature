...
Функционал: Негативная авторизация
    ...
    Сценарий: Проверка авторизации под ролью "just_employee" с невалидным заполнением поля "Имя пользователя"
    ...
    И на странице присутствует текст "Active Directory недоступен. Обратитесь к администратору"
